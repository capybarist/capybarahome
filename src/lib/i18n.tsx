...
const translations = {
  es: {
    ...
    // Spider live widget
    hive_spider_eyebrow: "Spider en vivo",
    hive_spider_title: "Lo que el bot está rastreando ahora mismo",
    hive_spider_sub: "Cada artículo de Wikipedia que indexa añade sus enlaces internos a una cola persistente. El bot drena la cola indefinidamente, como una araña de buscador.",
    hive_spider_updated: "Actualizado",
    hive_spider_card_indexed: "Fragments indexados",
    hive_spider_card_queue: "En cola",
    hive_spider_card_visited: "Artículos visitados",
    hive_spider_card_rate: "Ritmo (15s)",
    hive_spider_recent_title: "Últimos artículos procesados",
    hive_spider_recent_sub: "El bot acaba de indexar todas las secciones verbatim de estos artículos.",
    hive_spider_recent_empty: "El bot aún no ha procesado ningún artículo.",
    hive_spider_next_title: "Próximos en la cola",
    hive_spider_next_sub: "Descubiertos como enlaces internos en artículos ya procesados. Se procesarán en los siguientes ciclos.",
    hive_spider_next_empty: "Cola vacía. El bot pasará a modo de seeding en el próximo ciclo.",
  ...
  en: {
    ...
    // Spider live widget
    hive_spider_eyebrow: "Spider live",
    hive_spider_title: "What the bot is crawling right now",
    hive_spider_sub: "Every Wikipedia article it indexes feeds its internal links into a persistent queue. The bot drains that queue indefinitely, like a search-engine spider.",
    hive_spider_updated: "Updated",
    hive_spider_card_indexed: "Indexed fragments",
    hive_spider_card_queue: "Queued",
    hive_spider_card_visited: "Articles visited",
    hive_spider_card_rate: "Rate (15s)",
    hive_spider_recent_title: "Recently processed",
    hive_spider_recent_sub: "The bot just indexed every section of these articles verbatim.",
    hive_spider_recent_empty: "No articles processed yet.",
    hive_spider_next_title: "Next in queue",
    hive_spider_next_sub: "Discovered as internal links in articles already processed. Will be fetched in upcoming cycles.",
    hive_spider_next_empty: "Queue empty. The bot will enter seed mode on the next cycle.",
