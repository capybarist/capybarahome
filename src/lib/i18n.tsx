...
const translations = {
  es: {
    ...
    hive_status_badge: "v0.4 activo",
    hive_planned_title: "Próximo — v0.5+",
    ...
    hive_status_title: "Estado actual — v0.4",
    hive_status_desc: "HIVE v0.4 está en producción con replicación P2P nativa operativa y todos los módulos implementados.",
    hive_status_done: "Implementado",
    hive_status_m1: "Embeddings locales (all-MiniLM-L6-v2) + índice HNSW",
    hive_status_m2: "Extractor autónomo multi-fuente (Wikipedia, arXiv, RSS, web)",
    hive_status_m3: "KnowledgeStore en Hypercore + Hyperbee — replicación P2P nativa",
    hive_status_m4: "Red P2P — Hyperswarm + replicación Hypercore nativa (v0.4)",
    hive_status_m5: "API vectorial (Fastify) + búsqueda federada",
    hive_status_m6: "UI web — Groq / Gemini / Claude / OpenAI",
  ...
  en: {
    ...
    hive_status_badge: "v0.4 live",
    hive_planned_title: "Next — v0.5+",
    ...
    hive_status_title: "Current state — v0.4",
    hive_status_desc: "HIVE v0.4 is live with native P2P replication operational and all modules implemented.",
    hive_status_done: "Implemented",
    hive_status_m1: "Local embeddings (all-MiniLM-L6-v2) + HNSW index",
    hive_status_m2: "Autonomous extractor — Wikipedia, arXiv, RSS, web",
    hive_status_m3: "KnowledgeStore on Hypercore + Hyperbee — native P2P replication",
    hive_status_m4: "P2P network — Hyperswarm + native Hypercore replication (v0.4)",
    hive_status_m5: "Vector API (Fastify) + federated search",
    hive_status_m6: "Web UI — Groq / Gemini / Claude / OpenAI",
