          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <a href="https://acquislaw.com" target="_blank" rel="noopener"
              ...
              <p className="text-[var(--muted)] leading-relaxed mb-6 text-sm max-w-md">
                {en
                  ? "Verified EU law in a web app and inside Claude, ChatGPT & VS Code. Ask in plain language, get the verbatim provision with exact citations, EUR-Lex links and cryptographic verification — across 13 EU digital regulations."
                  : "Derecho digital de la UE verificado, en una app web y dentro de Claude, ChatGPT y VS Code. Pregunta en lenguaje natural y obtén la disposición textual con citas exactas, enlaces a EUR-Lex y verificación criptográfica — sobre 13 reglamentos."}
              </p>
